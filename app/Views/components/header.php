    ...
    <div class="header-top">
        <div class="container">
            ...
            <div class="ht-right">
                ...
                <a href="<?= site_url('logout') ?>" class="login-panel"><i class="fa fa-user"></i>Logout (
                ...
                <div class="lan-selector">
                    <select class="language_drop" name="countries" id="countries" style="width:300px;">
                        <option value='yt' data-image="<?= base_url('public/fashi-master/img/flag-1.jpg') ?>"
                            data-imagecss="flag yt" data-title="English">English</option>
                        <option value='yu' data-image="<?= base_url('public/fashi-master/img/flag-2.jpg') ?>"
        ...
        <div class="inner-header">
            <div class="row">
                <div class="col-lg-2 col-md-2">
                    <div class="logo">
                        <a href="<?= site_url('/') ?>">
                            <img src="<?= base_url('public/fashi-master//img/logo.png') ?>" alt="">
                        </a>
                    </div>
                </div>
            </div>
